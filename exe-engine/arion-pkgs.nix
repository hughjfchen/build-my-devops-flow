...
mypkgs.pkgs // rec { java-analyzer-uploader = mypkgs;
                     ...
                     exe-engine-config-local = mypkgs.pkgs.lib.generators.toKeyValue {} {
                     ...
                     exe-engine-config-local-file = mypkgs.pkgs.writeText "postgrest-config-local" postgrest-config-local;
                   }
